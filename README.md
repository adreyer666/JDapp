...
| Operation | SQL | HTTP | RESTful WS | DDS | MongoDB | |!------------------|!------|!------------------|!--------------|!----------|!----------| |Create |INSERT |PUT / POST |POST |write |Insert | |Read (Retrieve) |SELECT |GET |GET |read / take |Find | |Update (Modify) |UPDATE |PUT / POST / PATCH |PUT |write |Update | |Delete (Destroy) |DELETE |DELETE |DELETE |dispose |Remove |
